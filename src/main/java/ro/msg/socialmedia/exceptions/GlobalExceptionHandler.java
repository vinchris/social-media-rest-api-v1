...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @Override // first approach to validation error handling
...
//    @ExceptionHandler(MethodArgumentNotValidException.class) // second approach to validation error handling
